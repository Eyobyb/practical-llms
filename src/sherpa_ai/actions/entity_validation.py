...
class EntityValidationAction(BaseAction):
    ...
    args: dict = {"text": "string", "source": "string"}
    usage: str = "Validate entities in the text by comparing it to the source"
    ...
    def execute(self, text: str, source: str, **kwargs) -> ValidationResult:
        """
